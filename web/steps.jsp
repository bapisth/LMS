<jsp:include page="includes/includeMenu.jsp"/>
         ...
         <!-- Page Title
        ============================================= -->
        <section id="page-title" class="page-title-parallax page-title-dark" style="background-image: url('images/parallax/9.jpg'); padding: 120px 0;" data-stellar-background-ratio="0.3">
