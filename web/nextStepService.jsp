						...
						<div class="bg-gray">
							<div class="row">
								<div class="form-group">
									<div class="col-md-4">
										<label for="name"> Your estimated amount of bags <span
											class="color-red">*</span></label> <select class="form-control">
									...
									<div class="col-md-4">
										<label for="name"> Laundry Preferences <span
							...
							<div class="form-group">
								<a href="#"
									class="button button-3d  button-rounded button-red nomargin tab-linker">Save</a>
								<a href="#" class="button button-3d nomargin  tab-linker"
									rel="2">Next</a>
							</div>
						</div>
					...
					<div id="ptab2">
						...
						<div class="bg-gray">
							...
							<div class="form-group">
								<div class="row">
									<div class="col-md-6">
										<label for="name"> When would you like your first
											pickup ? <span class="color-red">*</span>
									...
									<div class="col-md-6">
										<label for="name"> Will you be present during pickup?
							...
							<div class="form-group">
								<div class="row">
									<div class="col-md-12">
										<label for="name"> Pickup instructions <span
											class="color-red">*</span></label> <input type="text"
											class="form-control" />
									</div>
							...
							<div class="form-group">
								<div class="row">
									<div class="col-md-6">
										<label for="name"> Will you be present during drop
											off? <span class="color-red">*</span>
										</label>
										<div class="radio-inline">
											<input type="radio" name="present" /> yes
										</div>
									...
									<div class="col-md-6">
										<label for="name"> Drop Off Instructions <span
											class="color-red">*</span></label><br> <input type="text"
											class="form-control" />
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								<div class="row">
									<div class="col-md-12">
										<label for="name"> Delivery will be 48 hours from
											pickup time (except weekends). Do you require next day rush
											service? <span class="color-red">*</span>
										</label> <select class="form-control">
					...
					<div id="ptab3">
						...
						<div class="bg-gray">
							<div class="form-group">
								<div class="row">
									<div class="col-md-6">
										<label for="name"> Cardholder Name <span
											class="color-red">*</span></label> <input type="text"
											class="form-control" />
									</div>
									<div class="col-md-6">
							...
							<div class="form-group">
								<div class="row">
									<div class="col-md-6">
										<label for="name"> credit card / Debit card<span
											class="color-red">*</span></label> <select class="form-control">
									...
									<div class="col-md-6">
										<label>Credit Card Number(Number Only Without
											Dashes/Spaces)<span class="color-red">*</span>
							...
							<div class="form-group">
								<div class="row">
									<div class="col-md-6">
										<label for="name"> Expiration Date <span
											class="color-red">*</span></label>
										<div class="row">
											<div class="col-sm-6">
												<select class="form-control">
									...
									<div class="col-md-6">
										<label>CCV Code <span class="color-red">*</span></label> <input
							...
							<div class="form-group">
								<div class="row">
									<div class="col-md-6">
										<label for="name"> How did you find Laundry Care? <span
											class="color-red">*</span></label> <select class="form-control">
									...
									<div class="col-md-6">
										<label>Coupon Code <span class="color-red">*</span>
										</label> <input type="text" class="form-control" />
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								<a href="#"
									class="button button-3d  button-rounded button-red nomargin tab-linker">Save
									& Submit</a>
