				...
				<div class="container">
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="index.html">
							<img src="images/laundry-logo.png" alt="laundry" width="60"/>
						</a>
						<!-- end: LOGO -->
					</div>
						...
						<ul class="nav navbar-right">
							...
							<li class="dropdown current-user">
								<a data-toggle="dropdown" data-hover="dropdown" class="dropdown-toggle" data-close-others="true" href="#">
									<img src="images/avatar-1-small.jpg" class="img-circle" alt=""> <span class="username hidden-xs">Janmenjaya Mohanty</span> <i class="fa fa-caret-down "></i>
								</a>
