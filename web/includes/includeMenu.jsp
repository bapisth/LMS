        ...
        <header id="header" class="transparent-header dark full-header no-sticky">
            ...
            <div id="header-wrap">
                ...
                <div class="container clearfix">
                    ...
                    ============================================= -->
                    <div id="logo">
                        <a href="index.html" class="standard-logo" data-dark-logo="images/laundry-logo.png"><img src="images/laundry-logo.png" width="190" alt=""></a>
                        <a href="index.html" class="retina-logo" data-dark-logo="images/laundry-logo.png"><img src="images/laundry-logo.png" width="250" alt=""></a>
                    </div><!-- #logo end -->
